...
class NSDrawer extends StatefulWidget {
  const NSDrawer(
      {GlobalKey key,
      this.leftChild,
      this.rightChild,
  ...
  @override
  NSDrawerState createState() => NSDrawerState();
}

class NSDrawerState extends State<NSDrawer>
  ...
  void openLeading() => open(direction: InnerDrawerDirection.start);
  void openTrailing() => open(direction: InnerDrawerDirection.end);

  void closeLeading() => close(direction: InnerDrawerDirection.start);
  void closeTrailing() => close(direction: InnerDrawerDirection.end);
